 ...
 */class le extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,s)=>{const o=s?.renderBefore??t;let i=o._$litPart$;if(void 0===i){const e=s?.renderBefore??null;o._$litPart$=i=new ee(t.insertBefore(z(),e),e,void 0,s??{})}return i._$AI(e),i})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return V}}le._$litElement$=!0,le.finalized=!0,re.litElementHydrateSupport?.({LitElement:le});const de=re.litElementPolyfillSupport;de?.({LitElement:le}),(re.litElementVersions??=[]).push("4.2.2");const ce=new class{constructor(){this._ws=null,this._listeners=[],this._reconnectDelay=1e3}connect(){const e="https:"===location.protocol?"wss:":"ws:",t=location.pathname.match(/^(\/api\/hassio_ingress\/[^/]+)/),s=t?t[1]:"",o=`${e}//${location.host}${s}/api/ws`;this._ws=new WebSocket(o),this._ws.onmessage=e=>{try{const t=JSON.parse(e.data);this._listeners.forEach(e=>e(t))}catch(e){console.error("WebSocket parse error:",e)}},this._ws.onclose=()=>{setTimeout(()=>this.connect(),this._reconnectDelay),this._reconnectDelay=Math.min(2*this._reconnectDelay,3e4)},this._ws.onopen=()=>{this._reconnectDelay=1e3}}onMessage(e){this._listeners.push(e)}disconnect(){this._ws&&this._ws.close()}};class pe extends le{static properties={currentView:{type:String}};static styles=a`
  ...
  `;render(){return H`
      <nav>
        ...
        <span class="version">v0.1.0 build ${"3/22 18:32"}</span>
      </nav>
    `}_navigate(e){this.dispatchEvent(new CustomEvent("view-change",{detail:{view:e}}))}}customElements.define("nav-bar",pe);const he=function(){const e=location.pathname.match(/^(\/api\/hassio_ingress\/[^/]+)/);return e?e[1]:""}();async function ue(){return(await fetch(`${he}/api/devices`)).json()}async function ge(e){return(await fetch(`${he}/api/devices/${e}`)).json()}async function me(){return(await fetch(`${he}/api/topology`)).json()}async function fe(e){return(await fetch(`${he}/api/topology/layouts`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function ve(){return(await fetch(`${he}/api/groups`)).json()}async function _e(e,t,s=[]){return(await fetch(`${he}/api/groups`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,name:t,device_ids:s})})).json()}async function be(e,{name:t,device_ids:s,custom_commands:o,custom_sensors:i,thresholds:a,hidden_commands:n}){return(await fetch(`${he}/api/groups/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,device_ids:s,custom_commands:o,custom_sensors:i,thresholds:a,hidden_commands:n})})).json()}async function xe(){return(await fetch(`${he}/api/tags`)).json()}async function ye(e){return(await fetch(`${he}/api/tags`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tag:e})})).json()}async function $e(e){await fetch(`${he}/api/tags/${encodeURIComponent(e)}`,{method:"DELETE"})}async function we(){return(await fetch(`${he}/api/settings`)).json()}async function ke(e){return(await fetch(`${he}/api/devices/${e}/effective-settings`)).json()}async function Se(e,t){return(await fetch(`${he}/api/devices/${e}/settings`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}class Ce extends le{static properties={selectedTags:{type:Array},_allTags:{type:Array,state:!0},_open:{type:Boolean,state:!0},_showCreate:{type:Boolean,state:!0},_newTagName:{type:String,state:!0},_creating:{type:Boolean,state:!0}};static styles=a`
  ...
  `;constructor(){super(),this.device=null,this.commandResult="",this._groups={},this._effectiveSettings=null,this._haOverrides={},this._configInterval=30,this._customSensors={},this._showAddSensor=!1,this._editSensorKey=null,this._sensorForm={name:"",command:"",interval:30,unit:""},this._pushing=!1,this._pushStatus="",this._lastPushed="",this._localChanges=!1,this._showGroupDialog=!1,this._newGroupName="",this._serverCommands={},this._newCommandName="",this._newCommandShell=""}connectedCallback(){super.connectedCallback(),this._loadDevice(),this._loadGroups(),this._startPolling(),ce.onMessage(e=>{"device_update"===e.type&&e.device_id===this.deviceId&&this._updateDeviceData(e.device)})}disconnectedCallback(){super.disconnectedCallback(),this._pollTimer&&clearInterval(this._pollTimer)}_startPolling(){this._pollTimer&&clearInterval(this._pollTimer);const e=1e3*parseInt(localStorage.getItem("mqtt-monitor-refresh")||"5");this._pollTimer=setInterval(()=>this._refreshDevice(),e)}async _refreshDevice(){try{const e=await ge(this.deviceId);this._updateDeviceData(e)}catch(e){}}_updateDeviceData(e){if(!e)return;const t=this.device||{};this.device={...t,...e}}async _loadDevice(){try{this.device=await ge(this.deviceId),this._haOverrides={...this.device.ha_exposure_overrides||{}};const e=this.device.server_commands;if(this._serverCommands=e&&!Array.isArray(e)?{...e}:{},this._configInterval=this.device.collection_interval||this.device.remote_config?.interval||30,this.device.remote_config){const e=this.device.remote_config.plugins?.custom_command?.commands||{};this._customSensors={...e}}try{this._effectiveSettings=await ke(this.deviceId)}catch(e){}}catch(e){console.error("Failed to load device:",e)}}async _loadGroups(){try{this._groups=await ve()}catch(e){console.error("Failed to load groups:",e)}}render(){if(!this.device)return H`<div style="padding: 40px; text-align: center; color: #888;">Loading...</div>`;const e=this.device,t="online"===e.status?"#81c784":"offline"===e.status?"#ef5350":"#ffb74d";return H`
    ...
    `}_renderGroupPolicy(){const e=Object.values(this._groups),t=this.device.group_policy||"",s=t?this._groups[t]:null,o=s?.thresholds||{};return H`
      <div class="section">
    ...
    `}async _onGroupPolicyChange(e){const t=e.target.value||null;try{await Se(this.deviceId,{group_policy:t}),await this._loadDevice()}catch(e){console.error("Failed to update group policy:",e)}}_renderAttributesSection(){const e=Object.entries(this.device.attributes||{}),t=this.device.hidden_attributes||[],s=e.filter(([e])=>!t.includes(e)),o=e.filter(([e])=>t.includes(e));return 0===e.length?H``:H`
      <div class="section">
    ...
    `}_isExposed(e){if(void 0!==this._haOverrides[e])return this._haOverrides[e];const t=this._effectiveSettings;return void 0===t?.ha_exposure_overrides?.[e]||t.ha_exposure_overrides[e]}_fromGroup(e){if(void 0!==this._haOverrides[e])return!1;const t=this._effectiveSettings;return void 0!==t?.ha_exposure_overrides?.[e]}_getThresholdForAttr(e){const t=this._effectiveSettings;if(!t)return null;const s=(t.thresholds||{})[e];if(null==s)return null;const o=this.device.threshold_overrides||{},i=this.device.group_policy,a=i?this._groups[i]:null;let n="global";return null!=o[e]?n="device":a&&a.thresholds&&null!=a.thresholds[e]&&(n="group"),{value:s,source:n}}_checkThreshold(e,t){if(!t||null==e||"number"!=typeof e)return!1;const s="object"==typeof t?t.value:t,o="object"==typeof t&&t.op||">";if(null==s)return!1;switch(o){case">":default:return e>s;case"<":return e<s;case">=":return e>=s;case"<=":return e<=s;case"==":return e===s;case"!=":return e!==s}}_getThresholdOp(e){const t=(this.device.threshold_overrides||{})[e];if(null!=t&&"object"==typeof t)return t.op||">";const s=this._effectiveSettings;if(!s)return">";const o=(s.thresholds||{})[e];return null!=o&&"object"==typeof o&&o.op||">"}_getThresholdVal(e){const t=(this.device.threshold_overrides||{})[e];if(null!=t)return"object"==typeof t?t.value:t;const s=this._getThresholdForAttr(e);return s?s.value:null}_renderAttrTile(e,t){const s=this._isExposed(e),o=this._getThresholdForAttr(e),i=null!=t.value?t.value:null,a=(this.device.threshold_overrides||{})[e],n=null!=a?a:o?o.value:null,r=this._checkThreshold(i,n),l=this._getThresholdOp(e),d=this._getThresholdVal(e);return H`
    ...
    `}_renderCommands(){const e=this.device.allowed_commands||[],t=this._serverCommands||{},s=Object.keys(t),o=[...new Set([...e,...s])],i=this.device.hidden_commands||[],a=o.filter(e=>!i.includes(e)),n=o.filter(e=>i.includes(e));return H`
      <div class="section">
    ...
    `}async _hideCommand(e){try{await async function(e,t){return(await fetch(`${he}/api/devices/${e}/commands/${t}`,{method:"DELETE"})).json()}(this.deviceId,e),await this._loadDevice()}catch(e){console.error("Failed to hide command:",e)}}async _unhideCommand(e){try{await async function(e,t){return(await fetch(`${he}/api/devices/${e}/commands/${t}/unhide`,{method:"POST"})).json()}(this.deviceId,e),await this._loadDevice()}catch(e){console.error("Failed to unhide command:",e)}}_startAddCommand(){this._showAddCommand=!0,this._editingCommandName=null,this._editCommandForm={name:"",shell:""}}_editCommand(e,t){this._editingCommandName=e,this._showAddCommand=!1,this._editCommandForm={name:e,shell:t}}_cancelCommandForm(){this._showAddCommand=!1,this._editingCommandName=null,this._editCommandForm=null}_saveCommand(){const e=this._editCommandForm;if(!e)return;const t=(e.name||"").trim(),s=(e.shell||"").trim();t&&s&&(this._serverCommands={...this._serverCommands,[t]:s},this._localChanges=!0,Se(this.deviceId,{server_commands:this._serverCommands}),this._cancelCommandForm())}_renderAgentConfig(){const e=this.device.remote_config||{},t=this.device.active_plugins||(e.plugins?Object.keys(e.plugins):[]),s=this._customSensors;return H`
      <div class="section">
  ...
  `;constructor(){super(),this.topology={nodes:[],edges:[]},this.layouts={},this.selectedLayout="",this.editMode=!1,this.linkMode=!1,this.selectedNode=null,this.nodePositions={},this.manualEdges=[],this._dragging=null,this._dragOffset={x:0,y:0},this._linkSource=null,this._error="",this._loading=!0,this._selectedEdge=-1,this._selectedDeviceData=null,this._commandResult="",this._dirty=!1,this._showSaveDialog=!1,this._showLabelDialog=!1,this._labelEdgeIndex=-1,this._savedPositions=null,this._savedManualEdges=null,this.hideAutoEdges=!1}connectedCallback(){super.connectedCallback(),this._loadTopology(),this._loadLayouts();const e=1e3*parseInt(localStorage.getItem("mqtt-monitor-refresh")||"5");this._pollTimer=setInterval(()=>{this._refreshNodeStatuses()},e),ce.onMessage(e=>{"device_update"===e.type&&this._refreshNodeStatuses()})}disconnectedCallback(){super.disconnectedCallback(),this._pollTimer&&clearInterval(this._pollTimer)}async _refreshNodeStatuses(){try{const e=await me();if(!e||!e.nodes)return;const t={};for(const s of e.nodes)t[s.id]=s.status;if(this.topology&&this.topology.nodes){let s=!1;const o=this.topology.nodes.map(e=>t[e.id]&&t[e.id]!==e.status?(s=!0,{...e,status:t[e.id]}):e);for(const t of e.nodes)this.topology.nodes.find(e=>e.id===t.id)||(o.push(t),s=!0);s&&(this.topology={...this.topology,nodes:o})}}catch(e){}}async _loadTopology(){try{this._loading=!0,this._error="";const e=await me();this.topology=e,this._autoLayout(),this._loading=!1}catch(e){console.error("Failed to load topology:",e),this._error=`Failed to load: ${e.message}`,this._loading=!1}}async _loadLayouts(){try{if(this.layouts=await async function(){return(await fetch(`${he}/api/topology/layouts`)).json()}(),!this._layoutsLoaded){this._layoutsLoaded=!0;const e=Object.entries(this.layouts).find(([,e])=>e.isDefault);e&&(this.selectedLayout=e[0],this.nodePositions=e[1].positions||{},this.manualEdges=e[1].manualEdges||[],this.hideAutoEdges=e[1].hideAutoEdges||!1)}}catch(e){console.error("Failed to load layouts:",e)}}_autoLayout(){const e=this.topology.nodes;if(!e.length)return;const t={...this.selectedLayout&&this.layouts[this.selectedLayout]&&this.layouts[this.selectedLayout].positions||{}},s=Math.ceil(Math.sqrt(e.length));e.forEach((e,o)=>{if(!t[e.id]){const i=o%s,a=Math.floor(o/s);t[e.id]={x:100+i*(800/(s+1)),y:80+100*a}}}),this.nodePositions=t,this.selectedLayout&&this.layouts[this.selectedLayout]&&(this.manualEdges=this.layouts[this.selectedLayout].manualEdges||[])}get _allEdges(){const e=this.hideAutoEdges?[]:this.topology.edges||[],t=this.manualEdges.map(e=>({...e,type:"manual"}));return[...e,...t]}_getNodeName(e){const t=this.topology.nodes.find(t=>t.id===e);return t&&t.name||e}render(){if(this._loading&&!this.topology.nodes.length)return H`<div style="padding: 40px; text-align: center; color: #888;">Loading topology...</div>`;if(this._error)return H`<div style="padding: 40px; text-align: center; color: #ef5350;">${this._error}</div>`;const e=this.topology.nodes,t=this._allEdges,s=e.filter(e=>"online"===e.status).length,o=e.filter(e=>"offline"===e.status).length,i=e.filter(e=>"warning"===e.status).length;return H`
    ...
    `}_renderNode(e){const t=this.nodePositions[e.id]||{x:100,y:100},s=Te[e.status]||Te.unknown,o=this.selectedNode===e.id,i=this._linkSource===e.id,a=o||i?2.5:1.5,n=o?"4,2":i?"2,2":"none",r=i?"#ffb74d":s;return"gateway"===e.type?B`
    ...
    `}_renderEdgeLabels(e,t){if(!e.label&&!e.sourceLabel&&!e.targetLabel)return B``;const s=this._edgeGeometry(e);if(!s)return B``;const{from:o,to:i,ux:a,uy:n,perpX:r,perpY:l,srcDist:d,tgtDist:c}=s,p=o.x+a*d,h=o.y+n*d,u=i.x-a*c,g=i.y-n*c,m=(o.x+i.x)/2+14*r,f=(o.y+i.y)/2+14*l;return B`
      ${e.label?B`
  ...
  `;render(){if(!this.device)return H``;const e=this.device,t=ze[e.status]||ze.unknown,s=Object.entries(e.attributes||{}).slice(0,4),o=[...e.tags||[],...e.server_tags||[]];return this.style.setProperty("--status-color",t),H`
      <div class="header">
      ...
      `:""}
    `}_isWarning(e,t){const s={cpu_usage:90,memory_usage:90,disk_usage:95,cpu_temp:80};return s[e]&&t.value>s[e]}}customElements.define("device-card",Ne);class Ge extends le{static properties={devices:{type:Object},filter:{type:String},selectedTags:{type:Array},viewMode:{type:String},_groups:{type:Object,state:!0},_collapsedGroups:{type:Object,state:!0},_refreshInterval:{type:Number,state:!0}};static styles=a`
    :host { display: block; padding: 20px; max-width: 1400px; margin: 0 auto; }
  ...
  `;constructor(){super(),this._tags=[],this._settings=null,this._groups={},this._devices={},this._loading=!0,this._newTagName="",this._renamingTag=null,this._renameValue="",this._expandedGroup=null,this._newGroupName="",this._editGroupName="",this._editingGroupName=null,this._savingSettings=!1,this._settingsSaved=!1,this._selectedTags=new Set,this._groupSaveStatus={},this._groupPushStatus={},this._editingGroupCmd=null,this._showAddGroupCmd=null,this._groupCmdForm={name:"",shell:""},this._editingGroupSensor=null,this._showAddGroupSensor=null,this._groupSensorForm={name:"",command:"",interval:"",unit:""}}connectedCallback(){super.connectedCallback(),this._loadAll()}async _loadAll(){this._loading=!0;try{const[e,t,s,o]=await Promise.all([xe().catch(()=>[]),we().catch(()=>({})),ve().catch(()=>({})),ue().catch(()=>({}))]);this._tags=Array.isArray(e)?e.map(e=>"string"==typeof e?{tag:e,count:0}:e).sort((e,t)=>e.tag.localeCompare(t.tag)):[],this._settings=t,this._groups=s||{},this._devices=o||{}}finally{this._loading=!1}}render(){return this._loading?H`<div class="loading">Loading settings...</div>`:H`
    ...
    `}_renderTagCard(e){const t=this._selectedTags&&this._selectedTags.has(e.tag),s=e.device_count||e.count||0;return H`
      <div class="tag-card ${t?"selected":""}" @click=${()=>this._toggleTagSelection(e.tag)}>
        <div class="tag-card-top">
          <span class="tag-card-name">${e.tag}</span>
        </div>
        <div class="tag-card-count">${s} device${1!==s?"s":""}</div>
        <div class="tag-card-actions">
          <button class="sensor-btn edit" @click=${t=>{t.stopPropagation(),this._startRename(e.tag)}}>Rename</button>
          <button class="sensor-btn remove" @click=${t=>{t.stopPropagation(),this._deleteTag(e.tag)}}>Delete</button>
        </div>
      </div>
    `}_toggleTagSelection(e){const t=new Set(this._selectedTags);t.has(e)?t.delete(e):t.add(e),this._selectedTags=t}async _deleteSelectedTags(){const e=[...this._selectedTags];if(confirm(`Delete ${e.length} tag${1!==e.length?"s":""}?`)){for(const t of e)try{await $e(t)}catch(e){console.error(e)}this._selectedTags=new Set,await this._loadAll()}}_startRename(e){this._renamingTag=e,this._renameValue=e}_cancelRename(){this._renamingTag=null,this._renameValue=""}async _saveRename(e){const t=this._renameValue.trim();if(t&&t!==e){try{await async function(e,t){return(await fetch(`${he}/api/tags/${encodeURIComponent(e)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({new_name:t})})).json()}(e,t),await this._loadAll()}catch(e){console.error("Failed to rename tag:",e)}this._cancelRename()}else this._cancelRename()}async _createTag(){const e=this._newTagName.trim();if(e)try{await ye(e),this._newTagName="",await this._loadAll()}catch(e){console.error("Failed to create tag:",e)}}async _deleteTag(e){const t=this._tags.find(t=>t.tag===e);if(!(t&&t.count>0)||confirm(`"${e}" is used by ${t.count} device(s). Delete anyway?`))try{await $e(e),await this._loadAll()}catch(e){console.error("Failed to delete tag:",e)}}_getGroupDiscoveredData(e){const t=e.device_ids||[],s=new Set,o={},i={};for(const e of t){const t=this._devices[e];if(!t)continue;if(t.attributes&&"object"==typeof t.attributes)for(const e of Object.keys(t.attributes))s.add(e);if(Array.isArray(t.allowed_commands))for(const e of t.allowed_commands)e in o||(o[e]="");if(t.server_commands&&"object"==typeof t.server_commands)for(const[e,s]of Object.entries(t.server_commands))o[e]=s||o[e]||"";const a=t.remote_config;if(a&&a.plugins&&a.plugins.custom_command&&a.plugins.custom_command.commands)for(const[e,t]of Object.entries(a.plugins.custom_command.commands))i[e]||(i[e]=t)}return{attributes:Array.from(s).sort(),commands:o,sensors:i}}_renderGroupPolicies(){const e=Object.values(this._groups);return H`
      <div class="section">
    ...
    `}_renderGroupCustomCommands(e){const t=e.custom_commands||{},s=this._getGroupDiscoveredData(e).commands,o={...s};for(const[e,s]of Object.entries(t))o[e]=s||o[e]||"";const i=e.hidden_commands||[],a=Object.entries(o).filter(([e])=>!i.includes(e)).sort(([e],[t])=>e.localeCompare(t)),n=Object.entries(o).filter(([e])=>i.includes(e)),r=this._editingGroupCmd&&this._editingGroupCmd.groupId===e.id,l=this._showAddGroupCmd&&this._showAddGroupCmd.groupId===e.id;return H`
      ...
      `}
    `}_startAddGroupCmd(e){this._showAddGroupCmd={groupId:e},this._editingGroupCmd=null,this._groupCmdForm={name:"",shell:""}}_startEditGroupCmd(e,t,s){this._editingGroupCmd={groupId:e,name:t},this._showAddGroupCmd=null,this._groupCmdForm={name:t,shell:s}}_cancelGroupCmdForm(){this._editingGroupCmd=null,this._showAddGroupCmd=null,this._groupCmdForm={name:"",shell:""}}_saveGroupCmd(e){const t=(this._groupCmdForm.name||"").trim(),s=(this._groupCmdForm.shell||"").trim();t&&s&&(this._groups={...this._groups,[e.id]:{...e,custom_commands:{...e.custom_commands||{},[t]:s}}},this._cancelGroupCmdForm())}_toggleDiscoveredCommand(e,t,s,o){const i={...e.custom_commands||{}};o?i[t]=s||"":delete i[t],this._groups={...this._groups,[e.id]:{...e,custom_commands:i}}}_removeGroupCommand(e,t){const s={...e.custom_commands||{}};delete s[t],this._groups={...this._groups,[e.id]:{...e,custom_commands:s}}}_hideGroupCommand(e,t){const s=[...e.hidden_commands||[]];s.includes(t)||s.push(t),this._groups={...this._groups,[e.id]:{...e,hidden_commands:s}}}_unhideGroupCommand(e,t){const s=(e.hidden_commands||[]).filter(e=>e!==t);this._groups={...this._groups,[e.id]:{...e,hidden_commands:s}}}_renderGroupThresholds(e){const t=e.thresholds||{},s=Pe(e.id),o=this._getGroupDiscoveredData(e).attributes,i=Object.keys(t).filter(e=>null!=t[e]&&!o.includes(e)),a=[...o,...i];return H`
      ${a.length>0?H`
      ...
      <div style="display: flex; gap: 4px; align-items: center; flex-wrap: wrap;">
        <input class="small-input" type="text" placeholder="Attribute name..."
          style="width: 150px;"
          .value=${s.attr}
          @input=${t=>{Pe(e.id).attr=t.target.value,this.requestUpdate()}}>
        <input class="small-input" type="number" placeholder="Value..."
          style="width: 90px;"
          .value=${s.value}
          @input=${t=>{Pe(e.id).value=t.target.value,this.requestUpdate()}}>
        <button class="small-btn" @click=${()=>this._addGroupThreshold(e)}>Add threshold</button>
      </div>
    `}_addGroupThreshold(e){const t=Pe(e.id),s=(t.attr||"").trim(),o=(t.value||"").trim();s&&""!==o&&(this._updateGroupThreshold(e.id,s,o),t.attr="",t.value="",this.requestUpdate())}_removeGroupThreshold(e,t){const s=this._groups[e];if(!s)return;const o={...s.thresholds||{}};delete o[t],this._groups={...this._groups,[e]:{...s,thresholds:o}}}_renderGroupCustomSensors(e){const t=e.custom_sensors||{},s=this._getGroupDiscoveredData(e).sensors,o=Object.keys(s).sort(),i=this._editingGroupSensor&&this._editingGroupSensor.groupId===e.id,a=this._showAddGroupSensor&&this._showAddGroupSensor.groupId===e.id;return H`
      ${o.length>0?H`
    ...
    `}_toggleGroup(e){this._expandedGroup=this._expandedGroup===e?null:e}_updateGroupThreshold(e,t,s){const o=this._groups[e];o&&(this._groups={...this._groups,[e]:{...o,thresholds:{...o.thresholds||{},[t]:""===s?null:Number(s)}}})}async _addMember(e,t){const s=[...e.device_ids||[],t];try{await be(e.id,{device_ids:s}),await this._loadAll()}catch(e){console.error("Failed to add member:",e)}}async _removeMember(e,t){const s=(e.device_ids||[]).filter(e=>e!==t);try{await be(e.id,{device_ids:s}),await this._loadAll()}catch(e){console.error("Failed to remove member:",e)}}async _updateGroup(e){const t=this._groups[e.id]||e,s=this._editingGroupName===e.id?this._editGroupName.trim():t.name,o={};for(const[e,s]of Object.entries(t.thresholds||{}))null==s||isNaN(s)||(o[e]=s);const i=s||t.name,a={name:i,device_ids:t.device_ids||[],custom_commands:t.custom_commands||{},custom_sensors:t.custom_sensors||{},thresholds:o,hidden_commands:t.hidden_commands||[]};console.log("Saving group:",e.id,a);try{await be(e.id,a),this._groups={...this._groups,[e.id]:{...e,name:i,thresholds:o}},this._editingGroupName===e.id&&(this._editingGroupName=null),this._groupSaveStatus={...this._groupSaveStatus,[e.id]:"saved"},setTimeout(()=>{this._groupSaveStatus={...this._groupSaveStatus,[e.id]:""}},2e3)}catch(t){console.error("Failed to update group:",t),this._groupSaveStatus={...this._groupSaveStatus,[e.id]:"error"},setTimeout(()=>{this._groupSaveStatus={...this._groupSaveStatus,[e.id]:""}},2e3)}}async _createGroup(){const e=this._newGroupName.trim();if(!e)return;const t=e.toLowerCase().replace(/[^a-z0-9]+/g,"_");try{await _e(t,e,[]),this._newGroupName="",this._expandedGroup=t,await this._loadAll()}catch(e){console.error("Failed to create group:",e)}}async _deleteGroup(e){const t=(e.device_ids||[]).length;if(!(t>0)||confirm(`Delete group "${e.name}"? It has ${t} member(s).`))try{await async function(e){await fetch(`${he}/api/groups/${e}`,{method:"DELETE"})}(e.id),this._expandedGroup===e.id&&(this._expandedGroup=null),await this._loadAll()}catch(e){console.error("Failed to delete group:",e)}}async _deployToDevices(e){await this._updateGroup(e);const t=this._groups[e.id]||e,s={commands:t.custom_commands||{},plugins:{custom_command:{commands:t.custom_sensors||{}}}},o=t.hidden_commands||[];if(o.length>0)for(const e of t.device_ids||[])try{await Se(e,{hidden_commands:o})}catch(t){console.error(`Failed to set hidden_commands on ${e}:`,t)}console.log("Deploy to group:",e.id,"config:",JSON.stringify(s)),this._groupPushStatus={...this._groupPushStatus,[e.id]:"Deploying..."};try{const t=await async function(e,t){return(await fetch(`${he}/api/groups/${e}/push-config`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}(e.id,s);console.log("Deploy result:",t),this._groupPushStatus={...this._groupPushStatus,[e.id]:"Deployed!"},setTimeout(()=>{this._groupPushStatus={...this._groupPushStatus,[e.id]:""}},3e3)}catch(t){console.error("Failed to deploy group config:",t);const s=t&&t.message?`Error: ${t.message}`:"Error";this._groupPushStatus={...this._groupPushStatus,[e.id]:s},setTimeout(()=>{this._groupPushStatus={...this._groupPushStatus,[e.id]:""}},3e3)}}_renderGlobalDefaults(){const e=(this._settings||{}).default_thresholds||{},t=Le;return H`
      <div class="section">
        ...
        <div style="display: flex; gap: 6px; align-items: center; margin-top: 8px; margin-bottom: 16px; flex-wrap: wrap;">
          <input class="small-input" type="text" placeholder="Attribute name..."
            style="width: 150px;"
            .value=${t.attr}
            @input=${e=>{Le.attr=e.target.value,this.requestUpdate()}}>
          <input class="small-input" type="number" placeholder="Value..."
            style="width: 90px;"
            .value=${t.value}
            @input=${e=>{Le.value=e.target.value,this.requestUpdate()}}>
    ...
    `}_updateDefaultThreshold(e,t){const s=this._settings||{};this._settings={...s,default_thresholds:{...s.default_thresholds||{},[e]:""===t?null:Number(t)}}}_removeDefaultThreshold(e){const t=this._settings||{},s={...t.default_thresholds||{}};delete s[e],this._settings={...t,default_thresholds:s}}_addDefaultThreshold(){const e=(Le.attr||"").trim(),t=(Le.value||"").trim();e&&""!==t&&(this._updateDefaultThreshold(e,t),Le.attr="",Le.value="",this.requestUpdate())}async _saveSettings(){this._savingSettings=!0,this._settingsSaved=!1;try{await async function(e){return(await fetch(`${he}/api/settings`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}(this._settings),this._settingsSaved=!0,setTimeout(()=>{this._settingsSaved=!1},2e3)}catch(e){console.error("Failed to save settings:",e)}finally{this._savingSettings=!1}}}customElements.define("settings-view",je);class Me extends le{static properties={currentView:{type:String},selectedDevice:{type:String}};static styles=a`
    :host {
      display: block;
      min-height: 100vh;
      background: #1a1a2e;
  ...
  `;constructor(){super(),this.currentView="dashboard",this.selectedDevice=null}connectedCallback(){super.connectedCallback(),ce.connect()}disconnectedCallback(){super.disconnectedCallback(),ce.disconnect()}render(){return H`
    ...
    `}_onOverlayClick(){this.selectedDevice=null}_onViewChange(e){this.currentView=e.detail.view,this.selectedDevice=null}_onDeviceSelect(e){this.selectedDevice=e.detail.deviceId}}customElements.define("network-monitor-app",Me);
