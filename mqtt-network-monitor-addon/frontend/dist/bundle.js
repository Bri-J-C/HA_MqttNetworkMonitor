 ...
 */class de extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,s)=>{const o=s?.renderBefore??t;let i=o._$litPart$;if(void 0===i){const e=s?.renderBefore??null;o._$litPart$=i=new ee(t.insertBefore(z(),e),e,void 0,s??{})}return i._$AI(e),i})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return V}}de._$litElement$=!0,de.finalized=!0,re.litElementHydrateSupport?.({LitElement:de});const le=re.litElementPolyfillSupport;le?.({LitElement:de}),(re.litElementVersions??=[]).push("4.2.2");const ce=new class{constructor(){this._ws=null,this._listeners=[],this._reconnectDelay=1e3}connect(){const e="https:"===location.protocol?"wss:":"ws:",t=location.pathname.match(/^(\/api\/hassio_ingress\/[^/]+)/),s=t?t[1]:"",o=`${e}//${location.host}${s}/api/ws`;this._ws=new WebSocket(o),this._ws.onmessage=e=>{try{const t=JSON.parse(e.data);this._listeners.forEach(e=>e(t))}catch(e){console.error("WebSocket parse error:",e)}},this._ws.onclose=()=>{setTimeout(()=>this.connect(),this._reconnectDelay),this._reconnectDelay=Math.min(2*this._reconnectDelay,3e4)},this._ws.onopen=()=>{this._reconnectDelay=1e3}}onMessage(e){return this._listeners.push(e),()=>{this._listeners=this._listeners.filter(t=>t!==e)}}disconnect(){this._ws&&this._ws.close()}};class pe extends de{static properties={currentView:{type:String}};static styles=a`
  ...
  `;render(){return H`
      <nav role="navigation" aria-label="Main navigation">
        ...
        <span class="version">v0.1.0 build ${"3/22 23:04"}</span>
      </nav>
    `}_navigate(e){this.dispatchEvent(new CustomEvent("view-change",{detail:{view:e}}))}}customElements.define("nav-bar",pe);const he=function(){const e=location.pathname.match(/^(\/api\/hassio_ingress\/[^/]+)/);return e?e[1]:""}();async function ue(e,t={}){const s=await fetch(e,t);if(!s.ok){const e=await s.text().catch(()=>s.statusText);throw new Error(`API error ${s.status}: ${e}`)}const o=s.headers.get("content-type");return o&&o.includes("application/json")?s.json():null}async function ge(e=0){return ue(e>0?`${he}/api/devices?since=${e}`:`${he}/api/devices`)}async function me(e){return ue(`${he}/api/devices/${e}`)}async function be(e){return ue(`${he}/api/devices/${e}`,{method:"DELETE"})}async function fe(e,t){return ue(`${he}/api/devices/${e}/attributes/${t}`,{method:"DELETE"})}async function ve(e,t){return ue(`${he}/api/devices/${e}/attributes/${t}/unhide`,{method:"POST"})}async function _e(e,t){return ue(`${he}/api/devices/${e}/commands/${t}`,{method:"DELETE"})}async function xe(e,t){return ue(`${he}/api/devices/${e}/commands/${t}/unhide`,{method:"POST"})}async function ye(){return ue(`${he}/api/topology`)}async function $e(){return ue(`${he}/api/topology/layouts`)}async function we(e){return ue(`${he}/api/topology/layouts`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async function ke(e){return ue(`${he}/api/topology/layouts/${e}`,{method:"DELETE"})}async function Se(e,t,s={}){return ue(`${he}/api/devices/${e}/command`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:t,params:s})})}async function Ce(){return ue(`${he}/api/groups`)}async function Ee(e,t,s=[]){return ue(`${he}/api/groups`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,name:t,device_ids:s})})}async function Ae(e,{name:t,device_ids:s,custom_commands:o,custom_sensors:i,thresholds:a,hidden_commands:n}){return ue(`${he}/api/groups/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,device_ids:s,custom_commands:o,custom_sensors:i,thresholds:a,hidden_commands:n})})}async function Te(e){return ue(`${he}/api/groups/${e}`,{method:"DELETE"})}async function De(e,t){return ue(`${he}/api/devices/${e}/tags/add`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tags:t})})}async function ze(e,t){return ue(`${he}/api/devices/${e}/tags/${t}`,{method:"DELETE"})}async function Ne(){return ue(`${he}/api/tags`)}async function Ge(e){return ue(`${he}/api/tags`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tag:e})})}async function Pe(e,t){return ue(`${he}/api/tags/${encodeURIComponent(e)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({new_name:t})})}async function Oe(e){return ue(`${he}/api/tags/${encodeURIComponent(e)}`,{method:"DELETE"})}async function Le(){return ue(`${he}/api/settings`)}async function je(e){return ue(`${he}/api/settings`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async function Fe(e){return ue(`${he}/api/devices/${e}/effective-settings`)}async function Me(e,t){return ue(`${he}/api/devices/${e}/settings`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async function Ie(e,t){return ue(`${he}/api/groups/${e}/push-config`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async function Ue(e,t=null){return ue(`${he}/api/groups/${e}/check-conflicts`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t?{new_device_id:t}:{})})}var Re=Object.freeze({__proto__:null,addDeviceTags:De,addServerCommand:async function(e,t,s){return ue(`${he}/api/devices/${e}/server-commands`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,shell:s})})},addServerSensor:async function(e,t,s){return ue(`${he}/api/devices/${e}/server-sensors`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,...s})})},checkGroupConflicts:Ue,createGroup:Ee,createTag:Ge,deleteAttribute:fe,deleteDevice:be,deleteGroup:Te,deleteLayout:ke,deleteTag:Oe,fetchDevice:me,fetchDevices:ge,fetchEffectiveSettings:Fe,fetchGroups:Ce,fetchLayouts:$e,fetchSettings:Le,fetchTags:Ne,fetchTopology:ye,hideCommand:_e,pushGroupConfig:Ie,removeDeviceTag:ze,removeServerCommand:async function(e,t){return ue(`${he}/api/devices/${e}/server-commands/${encodeURIComponent(t)}`,{method:"DELETE"})},removeServerSensor:async function(e,t){return ue(`${he}/api/devices/${e}/server-sensors/${encodeURIComponent(t)}`,{method:"DELETE"})},renameTag:Pe,saveLayout:we,sendCommand:Se,setDeviceInterval:async function(e,t){return ue(`${he}/api/devices/${e}/config-interval`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({interval:t})})},unhideAttribute:ve,unhideCommand:xe,updateDeviceSettings:Me,updateGroup:Ae,updateSettings:je});class He extends de{static properties={selectedTags:{type:Array},_allTags:{type:Array,state:!0},_open:{type:Boolean,state:!0},_showCreate:{type:Boolean,state:!0},_newTagName:{type:String,state:!0},_creating:{type:Boolean,state:!0}};static styles=a`
  ...
  `;constructor(){super(),this.selectedTags=[],this._allTags=[],this._open=!1,this._showCreate=!1,this._newTagName="",this._creating=!1,this._onDocClick=this._onDocClick.bind(this)}connectedCallback(){super.connectedCallback(),this._loadTags(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick)}async _loadTags(){try{const e=await Ne();Array.isArray(e)&&(this._allTags=e.map(e=>"string"==typeof e?e:e.tag).sort())}catch(e){console.error("Failed to load tags:",e)}}_onDocClick(e){if(!this._open)return;e.composedPath().includes(this)||(this._open=!1,this._showCreate=!1)}_toggle(e){e.stopPropagation(),this._open=!this._open,this._open||(this._showCreate=!1)}_toggleTag(e){(this.selectedTags||[]).includes(e)?this.dispatchEvent(new CustomEvent("tag-remove",{detail:{tag:e},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("tag-add",{detail:{tag:e},bubbles:!0,composed:!0}))}async _createTag(){const e=this._newTagName.trim();if(e&&!this._creating){this._creating=!0;try{await Ge(e),await this._loadTags(),this.dispatchEvent(new CustomEvent("tag-add",{detail:{tag:e},bubbles:!0,composed:!0})),this._newTagName="",this._showCreate=!1}catch(e){console.error("Failed to create tag:",e)}finally{this._creating=!1}}}render(){const e=this.selectedTags||[],t=e.length>0;return H`
      ...
      `:""}
    `}}customElements.define("tag-picker",He);class Be extends de{static properties={device:{type:Object},effectiveSettings:{type:Object},haOverrides:{type:Object},groups:{type:Object},cardAttributes:{type:Array},_showHidden:{type:Boolean,state:!0}};static styles=a`
  ...
  `;constructor(){super(),this.device=null,this.effectiveSettings=null,this.haOverrides={},this.groups={},this.cardAttributes=[],this._showHidden=!1}_isExposed(e){if(void 0!==this.haOverrides[e])return this.haOverrides[e];const t=this.effectiveSettings;return void 0===t?.ha_exposure_overrides?.[e]||t.ha_exposure_overrides[e]}_getThresholdForAttr(e){const t=this.effectiveSettings;if(!t)return null;const s=(t.thresholds||{})[e];if(null==s)return null;const o="object"==typeof s?s.value:s;if(null==o)return null;const i=this.device?.threshold_overrides||{},a=this.device?.group_policy,n=a?this.groups[a]:null;let r="global";return null!=i[e]?r="device":null!=n?.thresholds?.[e]&&(r="group"),{value:o,source:r}}_checkThreshold(e,t){if(!t||null==e||"number"!=typeof e)return!1;const s="object"==typeof t?t.value:t,o="object"==typeof t&&t.op||">";if(null==s)return!1;switch(o){case">":default:return e>s;case"<":return e<s;case">=":return e>=s;case"<=":return e<=s;case"==":return e===s;case"!=":return e!==s}}_getThresholdOp(e){const t=(this.device?.threshold_overrides||{})[e];if(null!=t&&"object"==typeof t)return t.op||">";const s=this.effectiveSettings;if(!s)return">";const o=(s.thresholds||{})[e];return null!=o&&"object"==typeof o&&o.op||">"}_getThresholdVal(e){const t=(this.device?.threshold_overrides||{})[e];if(null!=t)return"object"==typeof t?t.value:t;const s=this._getThresholdForAttr(e);return s?s.value:null}render(){if(!this.device)return H``;const e=Object.entries(this.device.attributes||{}).sort(([e],[t])=>e.localeCompare(t)),t=this.device.hidden_attributes||[],s=e.filter(([e])=>!t.includes(e)),o=e.filter(([e])=>t.includes(e));return 0===e.length?H``:H`
    ...
    `}_renderAttrTile(e,t){const s=this._isExposed(e),o=this._getThresholdForAttr(e),i=null!=t.value?t.value:null,a=(this.device?.threshold_overrides||{})[e],n=null!=a?a:o?o.value:null,r=this._checkThreshold(i,n),d=this._getThresholdOp(e),l=this._getThresholdVal(e),c=(this.cardAttributes||[]).includes(e);return H`
    ...
    `}_onDelete(e){this.dispatchEvent(new CustomEvent("attribute-deleted",{detail:{name:e},bubbles:!0,composed:!0}))}_onUnhide(e){this.dispatchEvent(new CustomEvent("attribute-unhidden",{detail:{name:e},bubbles:!0,composed:!0}))}_onToggleExposure(e){this.dispatchEvent(new CustomEvent("ha-exposure-toggled",{detail:{name:e},bubbles:!0,composed:!0}))}_onThresholdChange(e,t,s){this.dispatchEvent(new CustomEvent("threshold-changed",{detail:{name:e,value:t,op:s},bubbles:!0,composed:!0}))}_togglePin(e){this.dispatchEvent(new CustomEvent("pin-attribute",{detail:{name:e,pinned:!(this.cardAttributes||[]).includes(e)},bubbles:!0,composed:!0}))}}customElements.define("device-attributes",Be);const Ve=["shutdown","halt","poweroff","destroy"];class qe extends de{static properties={device:{type:Object},serverCommands:{type:Object},commandResult:{type:String},_showHiddenCmds:{type:Boolean,state:!0},_showAddCommand:{type:Boolean,state:!0},_editingCommandName:{type:String,state:!0},_editCommandForm:{type:Object,state:!0}};static styles=a`
    .section {
      background: #2a2a4a; border-radius: 8px; padding: 16px;
      margin-bottom: 16px;
    }
  ...
  `;constructor(){super(),this.device=null,this.commandResult="",this._groups={},this._effectiveSettings=null,this._haOverrides={},this._configInterval=30,this._customSensors={},this._pushing=!1,this._pushStatus="",this._lastPushed="",this._showGroupDialog=!1,this._newGroupName="",this._serverCommands={}}connectedCallback(){super.connectedCallback(),this._loadDevice(),this._loadGroups(),this._startPolling(),this._wsUnsub=ce.onMessage(e=>{"device_update"===e.type&&e.device_id===this.deviceId&&this._updateDeviceData(e.device)})}disconnectedCallback(){super.disconnectedCallback(),this._wsUnsub&&this._wsUnsub(),this._pollTimer&&clearInterval(this._pollTimer)}_startPolling(){this._pollTimer&&clearInterval(this._pollTimer);const e=1e3*parseInt(localStorage.getItem("mqtt-monitor-refresh")||"5");this._pollTimer=setInterval(()=>this._refreshDevice(),e)}async _refreshDevice(){try{const e=await me(this.deviceId);this._updateDeviceData(e)}catch(e){}}_updateDeviceData(e){e&&(this.device={...this.device||{},...e})}async _loadDevice(){try{this.device=await me(this.deviceId),this._haOverrides={...this.device.ha_exposure_overrides||{}};const e=this.device.server_commands;this._serverCommands=e&&!Array.isArray(e)?{...e}:{},this._configInterval=this.device.config_interval??this.device.collection_interval??this.device.remote_config?.interval??30;const t=this.device.server_sensors;this._customSensors=t&&"object"==typeof t?{...t}:{};try{this._effectiveSettings=await Fe(this.deviceId)}catch(e){}}catch(e){console.error("Failed to load device:",e)}}async _loadGroups(){try{this._groups=await Ce()}catch(e){console.error("Failed to load groups:",e)}}render(){if(!this.device)return H`<div style="padding: 40px; text-align: center; color: #888;">Loading...</div>`;const e=this.device,t="online"===e.status?"#81c784":"offline"===e.status?"#ef5350":"#ffb74d";return H`
      <!-- 1. Header -->
      <div class="header">
    ...
    `}async _addTag(e){e&&(await De(this.deviceId,[e]),await this._loadDevice())}async _removeTag(e){await ze(this.deviceId,e),await this._loadDevice()}_renderGroupPolicy(){const e=Object.values(this._groups),t=this.device.group_policy||"",s=t?this._groups[t]:null,o=s?.thresholds||{};return H`
      <div class="section">
  ...
  `;constructor(){super(),this.topology={nodes:[],edges:[]},this.layouts={},this.selectedLayout="",this.editMode=!1,this.linkMode=!1,this.selectedNode=null,this.nodePositions={},this.manualEdges=[],this._dragging=null,this._dragOffset={x:0,y:0},this._linkSource=null,this._error="",this._loading=!0,this._selectedEdge=-1,this._selectedDeviceData=null,this._commandResult="",this._dirty=!1,this._showSaveDialog=!1,this._showLabelDialog=!1,this._labelEdgeIndex=-1,this._savedPositions=null,this._savedManualEdges=null,this.hideAutoEdges=!1}connectedCallback(){super.connectedCallback(),this._loadTopology(),this._loadLayouts();const e=1e3*parseInt(localStorage.getItem("mqtt-monitor-refresh")||"5");this._pollTimer=setInterval(()=>{this._refreshNodeStatuses()},e),this._wsUnsub=ce.onMessage(e=>{"device_update"===e.type&&this._refreshNodeStatuses()})}disconnectedCallback(){super.disconnectedCallback(),this._wsUnsub&&this._wsUnsub(),this._pollTimer&&clearInterval(this._pollTimer)}async _refreshNodeStatuses(){try{const e=await ye();if(!e||!e.nodes)return;const t={};for(const s of e.nodes)t[s.id]=s.status;if(this.topology&&this.topology.nodes){let s=!1;const o=this.topology.nodes.map(e=>t[e.id]&&t[e.id]!==e.status?(s=!0,{...e,status:t[e.id]}):e);for(const t of e.nodes)this.topology.nodes.find(e=>e.id===t.id)||(o.push(t),s=!0);s&&(this.topology={...this.topology,nodes:o})}}catch(e){}}async _loadTopology(){try{this._loading=!0,this._error="";const e=await ye();this.topology=e,this._autoLayout(),this._loading=!1}catch(e){console.error("Failed to load topology:",e),this._error=`Failed to load: ${e.message}`,this._loading=!1}}async _loadLayouts(){try{if(this.layouts=await $e(),!this._layoutsLoaded){this._layoutsLoaded=!0;const e=Object.entries(this.layouts).find(([,e])=>e.isDefault);e&&(this.selectedLayout=e[0],this.nodePositions=e[1].positions||{},this.manualEdges=e[1].manualEdges||[],this.hideAutoEdges=e[1].hideAutoEdges||!1)}}catch(e){console.error("Failed to load layouts:",e)}}_autoLayout(){const e=this.topology.nodes;if(!e.length)return;const t={...this.selectedLayout&&this.layouts[this.selectedLayout]&&this.layouts[this.selectedLayout].positions||{}},s=Math.ceil(Math.sqrt(e.length));e.forEach((e,o)=>{if(!t[e.id]){const i=o%s,a=Math.floor(o/s);t[e.id]={x:100+i*(800/(s+1)),y:80+100*a}}}),this.nodePositions=t,this.selectedLayout&&this.layouts[this.selectedLayout]&&(this.manualEdges=this.layouts[this.selectedLayout].manualEdges||[])}get _allEdges(){const e=this.hideAutoEdges?[]:this.topology.edges||[],t=this.manualEdges.map(e=>({...e,type:"manual"}));return[...e,...t]}_getNodeName(e){const t=this.topology.nodes.find(t=>t.id===e);return t&&t.name||e}render(){if(this._loading&&!this.topology.nodes.length)return H`<div style="padding: 40px; text-align: center; color: #888;">Loading topology...</div>`;if(this._error)return H`<div style="padding: 40px; text-align: center; color: #ef5350;">${this._error}</div>`;const e=this.topology.nodes,t=this._allEdges,s=e.filter(e=>"online"===e.status).length,o=e.filter(e=>"offline"===e.status).length,i=e.filter(e=>"warning"===e.status).length;return H`
    ...
    `}_renderNode(e){const t=this.nodePositions[e.id]||{x:100,y:100},s=Ke[e.status]||Ke.unknown,o=this.selectedNode===e.id,i=this._linkSource===e.id,a=o||i?2.5:1.5,n=o?"4,2":i?"2,2":"none",r=i?"#ffb74d":s;return"gateway"===e.type?B`
  ...
  `;render(){if(!this.device)return H``;const e=this.device,t=Xe[e.status]||Xe.unknown,s=Object.entries(e.attributes||{}),o=e.hidden_attributes||[],i=e.card_attributes||[];let a;a=i.length>0?i.map(e=>s.find(([t])=>t===e)).filter(Boolean):s.filter(([e])=>!o.includes(e)).slice(0,4);const n=[...e.tags||[],...e.server_tags||[]],r=e.device_name||this.deviceId;return this.style.setProperty("--status-color",t),this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.setAttribute("aria-label",`${r}, ${e.status||"unknown"}`),H`
      <div class="header">
  ...
  `;constructor(){super(),this._groups={},this._devices={},this._loading=!0,this._expandedGroup=null,this._newGroupName="",this._editGroupName="",this._editingGroupName=null,this._groupSaveStatus={},this._groupPushStatus={},this._editingGroupCmd=null,this._showAddGroupCmd=null,this._groupCmdForm={name:"",shell:""},this._editingGroupSensor=null,this._showAddGroupSensor=null,this._groupSensorForm={name:"",command:"",interval:"",unit:""},this._conflictDialogConflicts=[],this._conflictDialogTitle="",this._conflictDialogAction="",this._conflictDialogPendingFn=null}connectedCallback(){super.connectedCallback(),this._loadAll()}async _loadAll(){this._loading=!0;try{const[e,t]=await Promise.all([Ce().catch(()=>({})),ge().catch(()=>({}))]);this._groups=e||{},this._devices=t||{}}finally{this._loading=!1}}render(){const e=Object.values(this._groups);return H`
    ...
    `}_getGroupDiscoveredData(e){const t=e.device_ids||[],s=new Set,o={},i={};for(const e of t){const t=this._devices[e];if(!t)continue;if(t.attributes&&"object"==typeof t.attributes)for(const e of Object.keys(t.attributes))s.add(e);if(Array.isArray(t.allowed_commands))for(const e of t.allowed_commands)e in o||(o[e]="");const a=t.remote_config;if(a&&a.plugins&&a.plugins.custom_command&&a.plugins.custom_command.commands)for(const[e,t]of Object.entries(a.plugins.custom_command.commands))i[e]||(i[e]=t)}return{attributes:Array.from(s).sort(),commands:o,sensors:i}}_renderGroupCustomCommands(e){const t=e.custom_commands||{},s=Object.entries(t).sort(([e],[t])=>e.localeCompare(t)),o=e.hidden_commands||[],i=s.filter(([e])=>!o.includes(e)),a=s.filter(([e])=>o.includes(e)),n=this._editingGroupCmd&&this._editingGroupCmd.groupId===e.id,r=this._showAddGroupCmd&&this._showAddGroupCmd.groupId===e.id;return H`
      ...
      `}
    `}_startAddGroupCmd(e){this._showAddGroupCmd={groupId:e},this._editingGroupCmd=null,this._groupCmdForm={name:"",shell:""}}_startEditGroupCmd(e,t,s){this._editingGroupCmd={groupId:e,name:t},this._showAddGroupCmd=null,this._groupCmdForm={name:t,shell:s}}_cancelGroupCmdForm(){this._editingGroupCmd=null,this._showAddGroupCmd=null,this._groupCmdForm={name:"",shell:""}}_saveGroupCmd(e){const t=(this._groupCmdForm.name||"").trim(),s=(this._groupCmdForm.shell||"").trim();t&&s&&(this._groups={...this._groups,[e.id]:{...e,custom_commands:{...e.custom_commands||{},[t]:s}}},this._cancelGroupCmdForm())}async _removeGroupCommand(e,t){const s=this._getLatestGroup(e),o={...s.custom_commands||{}};delete o[t];try{await Ae(e.id,this._buildGroupPayload(s,{custom_commands:o}))}catch(e){console.error("Failed to remove group command:",e)}await this._loadAll()}_getLatestGroup(e){return this._groups[e.id]||e}_buildGroupPayload(e,t={}){return{name:e.name,device_ids:e.device_ids||[],custom_commands:e.custom_commands||{},custom_sensors:e.custom_sensors||{},thresholds:e.thresholds||{},hidden_commands:e.hidden_commands||[],...t}}async _hideGroupCommand(e,t){const s=this._getLatestGroup(e),o=[...s.hidden_commands||[]];o.includes(t)||o.push(t);try{await Ae(e.id,this._buildGroupPayload(s,{hidden_commands:o}))}catch(e){console.error("Failed to hide group command:",e)}await this._loadAll()}async _unhideGroupCommand(e,t){const s=this._getLatestGroup(e),o=(s.hidden_commands||[]).filter(e=>e!==t);try{await Ae(e.id,this._buildGroupPayload(s,{hidden_commands:o}))}catch(e){console.error("Failed to unhide group command:",e)}await this._loadAll()}_renderGroupThresholds(e){const t=e.thresholds||{},s=this._getGroupDiscoveredData(e).attributes,o=Object.keys(t).filter(e=>null!=t[e]&&!s.includes(e)),i=[...s,...o];return 0===i.length?H`<div style="font-size: 12px; color: #555; margin-bottom: 6px;">No attributes discovered from member devices yet.</div>`:H`
      <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 6px;">
        ${i.map(s=>{const o=t[s],i=null!=o,a=i&&"object"==typeof o&&o.op||">",n=i?"object"==typeof o?o.value:o:null;return H`
            <div style="display: flex; align-items: center; gap: 4px; background: #12122a; border-radius: 6px; padding: 6px 8px; ${i?"border: 1px solid #2a2a5a;":""}">
              <span style="font-size: 11px; color: #ccc; flex: 1; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title=${s}>
                ${s.replace(/_/g," ")}
              </span>
              <span style="font-size: 9px; color: #666;">Warn</span>
              <select style="background: transparent; border: 1px solid #3a3a5a; border-radius: 3px; color: #aaa; padding: 2px; font-size: 10px; width: 36px;"
                .value=${a}
                @change=${t=>this._updateGroupThreshold(e.id,s,n,t.target.value)}>
                <option value=">">&gt;</option>
                <option value="<">&lt;</option>
                <option value=">=">&gt;=</option>
                <option value="<=">&lt;=</option>
              ...
              <input class="threshold-input" type="number" placeholder="\u2014"
                ...
                @change=${t=>this._updateGroupThreshold(e.id,s,t.target.value,a)}>
              ${i?H`
    ...
    `}_updateGroupThreshold(e,t,s,o=">"){const i=this._groups[e];if(!i)return;const a={...i.thresholds||{}};""===s||null==s?delete a[t]:a[t]={op:o,value:Number(s)},this._groups={...this._groups,[e]:{...i,thresholds:a}}}_removeGroupThreshold(e,t){const s=this._groups[e];if(!s)return;const o={...s.thresholds||{}};delete o[t],this._groups={...this._groups,[e]:{...s,thresholds:o}}}_renderGroupCustomSensors(e){const t=e.custom_sensors||{},s=this._editingGroupSensor&&this._editingGroupSensor.groupId===e.id,o=this._showAddGroupSensor&&this._showAddGroupSensor.groupId===e.id;return H`
    ...
    `}_toggleGroup(e){this._expandedGroup=this._expandedGroup===e?null:e}async _addMember(e,t){try{const s=await Ue(e.id,t);if(s&&s.conflict_count>0){const o=this._devices[t]&&this._devices[t].device_name||t;return this._conflictDialogTitle=`Adding "${o}" to group "${e.name}"`,this._conflictDialogAction="Add Device",this._conflictDialogConflicts=s.conflicts,void(this._conflictDialogPendingFn=()=>this._doAddMember(e,t))}}catch(e){console.error("Conflict check failed, proceeding anyway:",e)}await this._doAddMember(e,t)}async _doAddMember(e,t){const s=[...e.device_ids||[],t];try{await Ae(e.id,{device_ids:s}),await this._loadAll()}catch(e){console.error("Failed to add member:",e)}}async _removeMember(e,t){const s=(e.device_ids||[]).filter(e=>e!==t);try{await Ae(e.id,{device_ids:s}),await this._loadAll()}catch(e){console.error("Failed to remove member:",e)}}async _updateGroup(e){const t=this._groups[e.id]||e,s=this._editingGroupName===e.id?this._editGroupName.trim():t.name,o={};for(const[e,s]of Object.entries(t.thresholds||{}))null!=s&&("object"==typeof s&&null!=s.value?o[e]=s:"number"!=typeof s||isNaN(s)||(o[e]=s));const i=s||t.name,a={name:i,device_ids:t.device_ids||[],custom_commands:t.custom_commands||{},custom_sensors:t.custom_sensors||{},thresholds:o,hidden_commands:t.hidden_commands||[]};console.log("Saving group:",e.id,a);try{await Ae(e.id,a),this._groups={...this._groups,[e.id]:{...t,name:i,thresholds:o}},this._editingGroupName===e.id&&(this._editingGroupName=null),this._groupSaveStatus={...this._groupSaveStatus,[e.id]:"saved"},setTimeout(()=>{this._groupSaveStatus={...this._groupSaveStatus,[e.id]:""}},2e3)}catch(t){console.error("Failed to update group:",t),this._groupSaveStatus={...this._groupSaveStatus,[e.id]:"error"},setTimeout(()=>{this._groupSaveStatus={...this._groupSaveStatus,[e.id]:""}},2e3)}}async _createGroup(){const e=this._newGroupName.trim();if(!e)return;const t=e.toLowerCase().replace(/[^a-z0-9]+/g,"_");try{await Ee(t,e,[]),this._newGroupName="",this._expandedGroup=t,await this._loadAll()}catch(e){console.error("Failed to create group:",e)}}async _deleteGroup(e){const t=(e.device_ids||[]).length;if(!(t>0)||confirm(`Delete group "${e.name}"? It has ${t} member(s).`))try{await Te(e.id),this._expandedGroup===e.id&&(this._expandedGroup=null),await this._loadAll()}catch(e){console.error("Failed to delete group:",e)}}async _deployToDevices(e){await this._updateGroup(e);try{const t=await Ue(e.id);if(t&&t.conflict_count>0)return this._conflictDialogTitle=`Deploying group "${e.name}" to ${t.device_count} device${1!==t.device_count?"s":""}`,this._conflictDialogAction="Deploy",this._conflictDialogConflicts=t.conflicts,void(this._conflictDialogPendingFn=()=>this._doDeploy(e))}catch(e){console.error("Conflict check failed, proceeding anyway:",e)}await this._doDeploy(e)}async _doDeploy(e){const t=this._groups[e.id]||e,s={commands:t.custom_commands||{},plugins:{custom_command:{commands:t.custom_sensors||{}}}},o=t.hidden_commands||[];if(o.length>0)for(const e of t.device_ids||[])try{await Me(e,{hidden_commands:o})}catch(t){console.error(`Failed to set hidden_commands on ${e}:`,t)}console.log("Deploy to group:",e.id,"config:",JSON.stringify(s)),this._groupPushStatus={...this._groupPushStatus,[e.id]:"Deploying..."};try{const t=await Ie(e.id,s);console.log("Deploy result:",t),this._groupPushStatus={...this._groupPushStatus,[e.id]:"Deployed!"},setTimeout(()=>{this._groupPushStatus={...this._groupPushStatus,[e.id]:""}},3e3)}catch(t){console.error("Failed to deploy group config:",t);const s=t&&t.message?`Error: ${t.message}`:"Error";this._groupPushStatus={...this._groupPushStatus,[e.id]:s},setTimeout(()=>{this._groupPushStatus={...this._groupPushStatus,[e.id]:""}},3e3)}}}customElements.define("group-policy-settings",st);const ot={attr:"",value:""};class it extends de{static properties={_settings:{type:Object,state:!0},_loading:{type:Boolean,state:!0},_savingSettings:{type:Boolean,state:!0},_settingsSaved:{type:Boolean,state:!0}};static styles=a`
    :host { display: block; padding: 20px; max-width: 1000px; margin: 0 auto; }
  ...
  `;constructor(){super(),this._settings=null,this._loading=!0,this._savingSettings=!1,this._settingsSaved=!1}connectedCallback(){super.connectedCallback(),this._loadSettings()}async _loadSettings(){this._loading=!0;try{this._settings=await Le().catch(()=>({}))}finally{this._loading=!1}}render(){return this._loading?H`<div class="loading">Loading settings...</div>`:H`
    ...
    `}_renderGlobalDefaults(){const e=(this._settings||{}).default_thresholds||{},t=ot;return H`
      <div class="section">
        ...
        <div style="display: flex; gap: 6px; align-items: center; margin-top: 8px; margin-bottom: 16px; flex-wrap: wrap;">
          <input class="small-input" type="text" placeholder="Attribute name..."
            style="width: 150px;"
            .value=${t.attr}
            @input=${e=>{ot.attr=e.target.value,this.requestUpdate()}}>
          <input class="small-input" type="number" placeholder="Value..."
            style="width: 90px;"
            .value=${t.value}
            @input=${e=>{ot.value=e.target.value,this.requestUpdate()}}>
    ...
    `}_updateDefaultThreshold(e,t){const s=this._settings||{};this._settings={...s,default_thresholds:{...s.default_thresholds||{},[e]:""===t?null:Number(t)}}}_removeDefaultThreshold(e){const t=this._settings||{},s={...t.default_thresholds||{}};delete s[e],this._settings={...t,default_thresholds:s}}_addDefaultThreshold(){const e=(ot.attr||"").trim(),t=(ot.value||"").trim();e&&""!==t&&(this._updateDefaultThreshold(e,t),ot.attr="",ot.value="",this.requestUpdate())}async _saveSettings(){this._savingSettings=!0,this._settingsSaved=!1;try{await je(this._settings),this._settingsSaved=!0,setTimeout(()=>{this._settingsSaved=!1},2e3)}catch(e){console.error("Failed to save settings:",e)}finally{this._savingSettings=!1}}}customElements.define("settings-view",it);class at extends de{static properties={currentView:{type:String},selectedDevice:{type:String}};static styles=a`
    :host {
      display: block;
      min-height: 100vh;
      background: #1a1a2e;
